//it is a kind of edge if we remove it then our graph will divide into two or more components
//tarzan's algo
//to check articulation point we need to fulfil this condition
//low[nbr] >= disc[node] && parent!=-1;
//for check root node is a articulation point or nodt we need to satisfy this condition : -
//if(parent ==-1 && child>1);
